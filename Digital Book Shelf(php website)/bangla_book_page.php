...
if (isset($_POST['comment_snd'])) {
  ...
  if (empty($comment)) {
    ...
    $insert_query = "INSERT INTO bcomment (username ,book, comment, c_time)
                    ...
                    header('location: bangla_book_page.php?b_id='.$b_id);
...
hr {
  ...
  <body>
     ...
     <div class="container">
       ...
       <div class="row">
         ...
         <div class="col-md-6">
          ...
          <a href="<?php echo $_SESSION['dl_link'] ?>" download>  <button class="btn"><i class="fa fa-download"></i>  Download</button> </a> </p>
                </div>
     ...
     <div class="container">
          ...
          <form class="" action="bangla_book_page.php?b_id=<?php echo $b_id; ?>" method="post">
            <?php echo $error; ?> <br>
